...
// CreateUser создает нового пользователя в базе данных. В случае конфликта имени пользователя возвращает
// ошибку domain.ErrDuplicateKey, для остальных ошибок возвращает domain.ErrUnknown.
